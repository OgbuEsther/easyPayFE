    ...
    <Container>
      <Wrapper>
        ...
        <MainCard>
          ...
          <HolderData bg="#377dff" to="/admin/signin">
            <Content>
              <TextContext>Login as a company </TextContext>
              {/* <TextDetail>
          ...
          <HolderData bg="#8c0e0f" to="/user/signin">
            <Content>
              <TextContext>Login as a company's staff</TextContext>
              {/* <TextDetail>
                In the last days the mountain of the LORD’s temple will be
                established as the highest of the mountains... Micah 4:1
              </TextDetail> */}
